...
<!--	    <button onclick="table()">Submit</button>-->
    ...
    <table>
				    ...
				    <table>
				    	<tr>
				    		<td id="editTable3">
                                ...
                                <button type="button" value='Submit' onclick='generateRCACookie()' name='submitDB'>Begin RCA</button>
       ...
       //                  setCookie('RCACookie',newCookie);
                    ...
                    function goToTree(){
                        location.replace("http://localhost/PSG/RCATree.php");
